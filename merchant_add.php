...
if(isset($_POST['submit']))
{
  ...
  $sql="INSERT INTO merchant_details(name,image,price,discount,tax) values 
  ('$name','$hello','$price','$discount','$tax')";
    //var_dump($sql);exit;
  ...
  <h1 id="h1">Register Form <div>
    ...
    <form method="POST" class="myform" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" placeholder="Enter tax" name="tax" class="form-control" >
      </div>
