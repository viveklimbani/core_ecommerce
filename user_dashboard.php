...
<body>
	<h1 style="background:black; color: white"><center><b>General Dashboard</b></center></h1>
	<br><br>

	<div class="container">
		<a href='user_view.php'>
			<button class="btn btn-primary"> Manage User</button></a>
			<a href='user_item_view.php'>
				<button class="btn btn-primary"> Manage Items</button></a>
					...
					<a href='product_view.php'>
						<button class="btn btn-primary">Product Manage</button></a>
							<a href='customer_view.php'>
								<button class="btn btn-primary">Merchant View</button></a>
